...
| 2024-10-21 (Monday)    | Data collection report due                                                                                                                      | 1. You do not need to have all data ready, but you should have a solid plan and some data at this time point. <br/>2. Email your data collection report to me before class (2:30 pm) <br/>3. Start to build your model and train it |
...
1. **Assignments (30%)**: We will have 3 assignments, with **two** weeks for each assignment. Each assignment contributes 10% of your final grade.  The assignments goal is to let you buiild, traning, and test different types of neural network by PyTorch and PyTorch lightning.
