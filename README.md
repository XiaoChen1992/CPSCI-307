...
| 2024-09-16 (Monday)<br>Week 4  | 1. Weight decay<br>2. drop out<br>3. Stochastic Gradient Descent<br>4. Momentum, AdaGrad, Adam<br>5. Learning rate schedules                    | **Todo**:<br\>1. Work on Assignment 1 (2024-09-16)<br>2. Start to work on the final project's proposal                                                                                                                                                 |
...
| 2024-10-21 (Monday)<br>Week 9  | Guest Talk<br>1. Data augmentation<br>2. Fine-tune                                                                                              | **Due**: 1. Submit data collection report to gradescope before class (2:30 PM)<br>2. Submit Assignment 2 to gradescope before 2024-10-23 2:30 PM<br>**Todo**: 1. Start to work on model building and training<br> 2. Work on Assignment 3 (2014-10-23) |
...
| 2024-11-18 (Monday)<br>Week 13 | 1. Word embedding<br>2. Attention, axial attention, channel attention                                                                           | **Todo**: Start to work on proposal                                                                                                                                                                                                                    |
